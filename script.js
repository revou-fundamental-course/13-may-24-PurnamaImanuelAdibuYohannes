...
about.addEventListener("click", function (event) {
  ...
  contentDiv.innerHTML = `
    ...
    <div class="keterangan">
        <p>Pembuatan website bertujuan untuk menyelesaikan tugas mini course dari kelas RevoU Fundamental Course: Software Engineer 13/05/24 </p>
    </div>
    `;
});
